...
mixin _$AuthResponseModel {
 ...
 UserModel get data;@JsonKey(name: 'token') String get token;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthResponseModel&&(identical(other.data, data) || other.data == data)&&(identical(other.token, token) || other.token == token));
}
...
@override
String toString() {
  return 'AuthResponseModel(data: $data, token: $token)';
}
...
@useResult
$Res call({
 UserModel data,@JsonKey(name: 'token') String token
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( UserModel data, @JsonKey(name: 'token')  String token)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthResponseModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( UserModel data, @JsonKey(name: 'token')  String token)  $default,) {final _that = this;
switch (_that) {
case _AuthResponseModel():
return $default(_that.data,_that.token);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( UserModel data, @JsonKey(name: 'token')  String token)?  $default,) {final _that = this;
switch (_that) {
case _AuthResponseModel() when $default != null:
return $default(_that.data,_that.token);case _:
  return null;
...
class _AuthResponseModel extends AuthResponseModel {
  const _AuthResponseModel({required this.data, @JsonKey(name: 'token') this.token = ''}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AuthResponseModel&&(identical(other.data, data) || other.data == data)&&(identical(other.token, token) || other.token == token));
}
